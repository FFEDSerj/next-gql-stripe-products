...
export type AddToCartMutation = {
  ...
  addItem?: {
    ...
    items: Array<{
      ...
      image?: string | null;
      quantity: number;
      unitTotal: { __typename?: "Money"; formatted: string; amount: number };
...
export type DecreaseCartItemMutation = {
  __typename?: "Mutation";
  decreaseCartItem?: {
    __typename?: "Cart";
    id: string;
...
export type IncreaseCartItemMutation = {
  __typename?: "Mutation";
  increaseCartItem?: {
    __typename?: "Cart";
    id: string;
...
> = {
  ...
  createCheckoutSession?: Resolver<
    Maybe<ResolversTypes["CheckoutSession"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateCheckoutSessionArgs, "input">
  >;
...
export const DecreaseCartItemDocument = gql`
  ...
  ${CartFragmentDoc}
`;
export type DecreaseCartItemMutationFn = Apollo.MutationFunction<
  DecreaseCartItemMutation,
  DecreaseCartItemMutationVariables
>;
...
export function useDecreaseCartItemMutation(
  ...
  return Apollo.useMutation<
    DecreaseCartItemMutation,
    DecreaseCartItemMutationVariables
  >(DecreaseCartItemDocument, options);
}
export type DecreaseCartItemMutationHookResult = ReturnType<
  typeof useDecreaseCartItemMutation
>;
export type DecreaseCartItemMutationResult =
  Apollo.MutationResult<DecreaseCartItemMutation>;
export type DecreaseCartItemMutationOptions = Apollo.BaseMutationOptions<
  DecreaseCartItemMutation,
  DecreaseCartItemMutationVariables
>;
...
export const IncreaseCartItemDocument = gql`
  ...
  ${CartFragmentDoc}
`;
export type IncreaseCartItemMutationFn = Apollo.MutationFunction<
  IncreaseCartItemMutation,
  IncreaseCartItemMutationVariables
>;
...
export function useIncreaseCartItemMutation(
  ...
  return Apollo.useMutation<
    IncreaseCartItemMutation,
    IncreaseCartItemMutationVariables
  >(IncreaseCartItemDocument, options);
}
export type IncreaseCartItemMutationHookResult = ReturnType<
  typeof useIncreaseCartItemMutation
>;
export type IncreaseCartItemMutationResult =
  Apollo.MutationResult<IncreaseCartItemMutation>;
export type IncreaseCartItemMutationOptions = Apollo.BaseMutationOptions<
  IncreaseCartItemMutation,
  IncreaseCartItemMutationVariables
>;
